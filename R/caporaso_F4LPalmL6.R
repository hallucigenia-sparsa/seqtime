#' @title Caporaso Left Palm Sequencing Data for Subject F4 on level 6
#'
#' @description Mostly genus-level counts (L6) from left palm skin samples of subject F4 over time.
