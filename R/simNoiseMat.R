...
#' identifyNoisetypes(simNoiseMat(samples=500,noisetypes=list(white=0,brown=0,pink=10)))
#' @export
  ...
  if(noisetypes$brown > 0){
    ...
    if(brown.type == "gbm"){
      ...
      if (!requireNamespace("sde", quietly = TRUE)) {
        stop("sde is not installed. Please install it.", call. = FALSE)
      }
    }
