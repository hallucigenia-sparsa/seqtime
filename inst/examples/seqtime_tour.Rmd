...
ricker.taylor=taylor(out.ricker, pseudo=1, col="green", type="taylor")
```
...
```{r}
soi.taylor=taylor(out.soi, pseudo=1, col="blue", type="taylor")
```
...
```{r}
hubbell.taylor=taylor(out.hubbell, pseudo=1, col="blue", type="taylor")
```
...
```{r}
dm.uneven.taylor=taylor(dm.uneven, pseudo=1, col="orange", type="taylor", header="Dirichlet-Multinomial")
```
...
dm.even.taylor=taylor(dm.even, pseudo=1, col="orange", type="taylor", header="Even Dirichlet-Multinomial")
```
